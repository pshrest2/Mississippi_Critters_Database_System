...
<?php
	...
	function new_header($name="Pranaya Shrestha", $urlLink="FinalProject/read_animals.php") {
		echo "<head>";
		...
		echo "<li class='name'>";
		echo "  <h1 align='left'><a href='/~pshrest2/".$urlLink."'>$name</a></h1>";
		echo "</li>";
		echo "</ul>";
		echo "</nav>";
		echo "</div>";	
	...
	function new_footer($name="Pranaya Shrestha"){
